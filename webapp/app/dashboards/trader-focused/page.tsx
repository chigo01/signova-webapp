  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <header className="flex h-16 items-center justify-between border-b border-border px-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <h1 className="text-lg font-bold">EURUSD</h1>
      ...
      <div className="flex flex-1 flex-col lg:flex-row overflow-hidden">
        ...
        <div className="flex-1 border-r border-border bg-card/50 p-4 min-h-[500px] lg:min-h-auto flex flex-col">
        ...
        {/* Right: Execution & Management (Fixed Width) */}
        <div className="w-full lg:w-[400px] flex flex-col bg-background">
          <div className="p-4">
            <OrderPanel />
          </div>
