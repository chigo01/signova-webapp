  ...
  return (
    <div className="relative flex-1 overflow-hidden">
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center bg-zinc-950/60">
        <div className="flex flex-col items-center gap-4 rounded-2xl border border-zinc-800 bg-zinc-900/80 px-10 py-10 text-center shadow-xl">
      ...
      <main className="pointer-events-none select-none overflow-y-auto overflow-x-hidden opacity-50 blur-[2px]">
        <div className="p-8">
          {/* Header */}
